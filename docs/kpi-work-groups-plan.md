...
> **สถานะ: ✅ Phase A-E เสร็จหมดแล้ว (2026-07-16 → 2026-07-19)** · เหลือ **Phase F** เท่านั้น (ฟิลเตอร์ "KPI ของกลุ่มงานฉัน") · เขียน 2026-07-16
...
**A-E เสร็จหมดแล้ว** · เหลือ **F** เท่านั้น — แต่จะเห็นผลจริงก็ต่อเมื่อมี account ที่สังกัดกลุ่มงานเดียวกับ KPI จริง (ตอนนี้ยังไม่มี — ดูคำเตือนใน §3.2)
...
- ลำดับที่ทำจริง: A → B → bug sweep → C → ตรวจ C ซ้ำ (เจอ+แก้บั๊ก) → D → E — เหลือ **F** อย่างเดียว

## 17. งานที่เหลือ — Phase F

ฟิลเตอร์ "KPI ของกลุ่มงานฉัน" ใน `/dashboard` + `/kpi` — ยังไม่เริ่ม

**สิ่งที่ต้องรู้ก่อนเริ่ม:** ตอนนี้ยังไม่มี account จริงคนไหนสังกัดกลุ่ม `ปฐมภูมิ` เลย (39 KPI ทั้งหมดอยู่ปฐมภูมิ แต่ admin/สมชาย/สมหญิง อยู่คนละกลุ่ม) — ทดสอบฟิลเตอร์ได้ทันทีด้วย 3 account ที่มีอยู่ (ควรเห็น 0 ตัวทุกคน ยกเว้น admin ที่เห็นครบตามปกติ) แต่จะเห็นผล "กรองแล้วเจอ KPI จริง" ต้องรอสร้าง account ให้ 4 owner ก่อน (§8.0 — ตั้งใจยังไม่ทำ)
